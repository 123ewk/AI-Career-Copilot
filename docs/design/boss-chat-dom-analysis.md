...
> 分析时间：2026-07-19（更新）
> 分析工具：Chrome MCP Server (mcp-chrome-bridge, accessibility tree)
...
**观察到的对话项数据（2026-07-19 live page）：**

| 时间 | 姓名 | 公司 | 职位 | 状态 | 消息预览 |
|------|------|------|------|------|----------|
| 14:26 | 罗先生 | 聚搜云 | 运营总监 | [送达] | 您好，我是南华大学本科生，可以和您进一步沟通JAVA, Python, php实习生职位吗？ |
| - | 罗女士 | 科脉技术 | - | [送达] | 您好，我是南华大学本科生，可以和您进一步沟通python实习生职位吗？ |
| - | (无夕教育科技) | 无夕教育科技 | CEO | [送达] | 您好，我是南华大学本科生，可以和您进一步沟通招聘大学生Python实习生职位吗？ |
...
| 选择器 | 来源 | 状态 |
|--------|------|------|
| `.user-list-content` 对话列表容器 | 下载 HTML | ✅ 已验证 |
| `.friend-content` 对话项 | 下载 HTML | ✅ 已验证 |
| `.name-text` HR 姓名 | 下载 HTML | ✅ 已验证 |
| `.last-msg-text` 消息预览 | 下载 HTML | ✅ 已验证 |
| `.selected` 选中状态 | 下载 CSS | ✅ 已验证 |
| `#chat-input` 输入框 | **live page** | ✅ 已验证（contenteditable div） |
| `button[type="send"]` 发送按钮 | **live page** | ✅ 已验证 |
| `.conversation-message` 消息容器 | 下载 CSS | ⚠️ 仅 CSS 推断 |
| `.message-item` 消息项 | 下载 CSS | ⚠️ 仅 CSS 推断 |
| `.item-myself` 用户消息 | 下载 CSS | ⚠️ 仅 CSS 推断 |
| `.chat-other` 招聘方消息 | 下载 CSS | ⚠️ 仅 CSS 推断 |
